// Exact XenosRecomp translation of rage_postfx_ps17.bin. The sole behavioral
...
)
{
...
#endif
#ifdef __air__
	float4 c252 = as_type<float4>(uint4(0x0, 0x3F800000, 0x3F000000, 0x43800000));
#else
	float4 c252 = asfloat(uint4(0x0, 0x3F800000, 0x3F000000, 0x43800000));
#endif
#ifdef __air__
	...
	r1.w = (float)((-r10.x * dofProj.w));
	r2.z = (float)((dot(r5.zxy, c254.xyz)));
	r4.x = (float)((dot(r9.zxy, c254.xyz)));
	r4.y = (float)((dot(r8.zxy, c254.xyz)));
	r4.z = (float)((dot(r3.zxy, c254.xyz)));
	r4.w = (float)((dot(r7.zxy, c254.xyz)));
	r11.xyzw = (float4)((r3.wyzx * c252.wzzz));
	ps = dofProj.y * dofProj.x;
	r6.w = ps;
	r13.xyzw = (float4)((selectWrapper(c252.xyyy == 0.0, r2.zzzz, r4.xxwy)));
	r12.xyzw = (float4)((c255.xyzw >= r11.xxxx));
	ps = -r11.x >= 0.0;
	r0.z = ps;
	r3.w = (float)((r0.z + -r12.z));
	ps = dofBlur.x - dofBlur.y;
	r11.x = ps;
	r10.w = (float)((dot(r13.yzwx, c250.xxxx)));
	ps = r12.x - r12.w;
	r3.x = ps;
	r4.xyzw = (float4)((-r10.wwww + r4.xzyw));
	ps = r12.z - r12.y;
	r3.y = ps;
	r1.xyz = (float3)((r10.yzz * dofProj.zyx));
	ps = r12.y - r12.x;
	r3.z = ps;
	r0.z = (float)((dot(r3.xzyw, c254.wwww)));
	ps = r1.y - r1.z;
	r7.w = ps;
	r3.xyzw = (float4)((r3.wyxz * c254.wwww));
	ps = c253.w + r0.z;
	r5.w = ps;
	r6.xyz = (float3)((r3.xxx * r7.zyx + r11.zyw));
	r6.xyz = (float3)((r3.yyy * r8.xzy + r6.zxy));
	r0.z = (float)((r7.w + dofProj.x));
	ps = clamp(rcp(r5.w), -FLT_MAX, FLT_MAX);
	r3.x = ps;
	r4.y = (float)((r4.y * r4.y));
	ps = clamp(rcp(r0.z), -FLT_MAX, FLT_MAX);
	r3.y = ps;
	r6.xyz = (float3)((r3.www * r9.xzy + r6.xyz));
	r6.xyz = (float3)((r3.zzz * r5.xzy + r6.xyz));
	r6.xyzw = (float4)((r6.xyzw * r3.xxxy));
	ps = dofBlur.z - dofBlur.y;
	r11.y = ps;
	r3.xyz = (float3)((r2.xyw * Exposure.xxx));
	ps = max(r6.w, r6.w);
	r0.z = ps;
	r2.y = (float)((r6.w + -dofDist.w));
	ps = dofDist.w - r0.z;
	r2.x = ps;
	r1.xw = (float2)((r1.wx * r6.ww));
	ps = clamp(rcp(dofDist.x), -FLT_MAX, FLT_MAX);
	r0.z = ps;
	r12.xyz = (float3)((-r6.www * motionBlurMatrix(2).zxy + motionBlurMatrix(3).zxy));
	r1.xyz = (float3)((r1.xxx * motionBlurMatrix(1).zxy + r12.xyz));
	r2.yw = (float2)((-dofDist.yy * c253.ww + r2.xy));
	r1.xyz = (float3)((r1.www * motionBlurMatrix(0).zxy + r1.xyz));
	r3.w = (float)((r0.w >= PLAYER_MASK.x));
	ps = dofProj.w * r1.x;
	r1.w = ps;
	r2.x = (float)((-r1.x * dofProj.z));
	ps = clamp(rcp(dofDist.z), -FLT_MAX, FLT_MAX);
	r0.w = ps;
	r2.yw = (float2)((max(r2.yw, c252.xx)));
	ps = clamp(rcp(r2.x), -FLT_MAX, FLT_MAX);
	r2.x = ps;
	r0.zw = (float2)((r2.yw * r0.zw));
	ps = clamp(rcp(r1.w), -FLT_MAX, FLT_MAX);
	r2.y = ps;
	r0.zw = (float2)((r0.zw * r11.xy + dofBlur.yy));
	r2.xy = (float2)((r1.yz * r2.xy));
	r0.zw = (float2)((min(r0.zw, dofBlur.xz)));
	ps = -abs(r0.x) > 0.0;
	r1.y = ps;
	r2.yzw = (float3)((-r10.yxw + r2.xyz));
	ps = max(r0.z, r0.w);
	r2.x = ps;
	r1.z = (float)((dot(r4.xwz, r4.xwz)));
	...
	ps = c250.y * r1.x;
	r4.x = ps;
	r1.z = (float)((r4.y >= r1.z));
	ps = c252.y - r0.z;
	r2.x = ps;
	r1.z = (float)((r2.x * r1.z + r0.z));
	r0.z = (float)((r1.z * c250.x));
	ps = c250.y * r1.w;
	r4.y = ps;
	r2.xyz = (float3)((r0.zzz * r9.xzy));
	ps = c252.y - r1.z;
	r0.w = ps;
	r2.xyz = (float3)((r0.zzz * r8.xzy + r2.xyz));
	r2.xyz = (float3)((r0.zzz * r7.xzy + r2.xyz));
	r2.xyz = (float3)((r6.xyz * r0.www + r2.xyz));
	r2.yz = (float2)((r0.zz * r5.yz + r2.zy));
	r0.z = (float)((r0.z * r5.x + r2.x));
	r2.x = (float)((r0.z * r1.z));
	...
	if (p0)
	{
		r0.zw = (float2)((r2.xy * c255.xx));
	}
	if (p0)
	{
		r0.zw = (float2)((r0.xy * c251.yx + r0.zw));
	}
	if (p0)
	{
		r0.z = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			JitterSampler_Texture2DDescriptorIndex, JitterSampler_SamplerDescriptorIndex, r0.zw, float2(0, 0), GetTextureLodBias(5)).x;
	}
	if (p0)
	{
		ps = -c253.w - -r0.z;
	...
	if (p0)
	{
		r0.xy = (float2)((r4.xy * r0.zz + r0.xy));
	}
	if (p0)
	{
		r8.zw = (float2)((r0.xy + r4.xy));
		ps = c251.z * r1.w;
		r5.y = ps;
	}
	if (p0)
	{
		r13.xyzw = (float4)((r1.xwxw * c253.zzww + r0.xyxy));
	}
	if (p0)
	{
	...
	if (p0)
	{
		r4.xyz = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			HDRSampler_Texture2DDescriptorIndex, HDRSampler_SamplerDescriptorIndex, r12.xy, float2(0, 0), GetTextureLodBias(2)).xyz;
	}
	if (p0)
	{
		r5.xyz = tfetch2D(
	...
	if (p0)
	{
		r9.yzw = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			HDRSampler_Texture2DDescriptorIndex, HDRSampler_SamplerDescriptorIndex, r12.zw, float2(0, 0), GetTextureLodBias(2)).xyz;
	}
	if (p0)
	{
		r11.yzw = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			HDRSampler_Texture2DDescriptorIndex, HDRSampler_SamplerDescriptorIndex, r8.zw, float2(0, 0), GetTextureLodBias(2)).xyz;
	}
	if (p0)
	{
		r0.x = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			StencilCopySampler_Texture2DDescriptorIndex, StencilCopySampler_SamplerDescriptorIndex, r12.xy, float2(0, 0), GetTextureLodBias(6)).z;
	}
	if (p0)
	{
		r0.y = tfetch2D(
	...
	if (p0)
	{
		r8.z = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			StencilCopySampler_Texture2DDescriptorIndex, StencilCopySampler_SamplerDescriptorIndex, r8.zw, float2(0, 0), GetTextureLodBias(6)).z;
	}
	if (p0)
	{
		r8.w = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			StencilCopySampler_Texture2DDescriptorIndex, StencilCopySampler_SamplerDescriptorIndex, r12.zw, float2(0, 0), GetTextureLodBias(6)).z;
	}
	if (p0)
	{
		r1.xw = (float2)((r1.xw * globalScreenSize.xy));
	}
	if (p0)
	{
		r1.x = (float)((dot(r1.xw, r1.xw) + c252.x));
	}
	if (p0)
	{
	...
	if (p0)
	{
		r0.xzw = (float3)((r0.xzy >= PLAYER_MASK.xxx));
		ps = c252.y + r1.z;
		r0.y = ps;
	}
	if (p0)
	{
		r11.x = (float)((dot(-r0.wxz, c252.yyy)));
		ps = c252.y - r0.w;
		r3.w = ps;
	}
	if (p0)
	...
	if (p0)
	{
		r11.y = (float)((r8.w * r11.y + r2.x));
	}
	if (p0)
	{
		r11.zw = (float2)((r8.ww * r11.zw + r2.yz));
	}
	if (p0)
	{
	...
	if (p0)
	{
		r1.xzw = (float3)((r8.xxx * r10.xyz + r9.yzw));
	}
	if (p0)
	{
	...
	if (p0)
	{
		r1.xzw = (float3)((r8.zzz * r7.xyz + r1.xzw));
	}
	if (p0)
	{
		r1.xzw = (float3)((r3.www * r6.xyz + r1.xzw));
	}
	if (p0)
	{
		r1.xzw = (float3)((r0.zzz * r5.xyz + r1.xzw));
	}
	if (p0)
	{
		r1.xzw = (float3)((r2.www * r4.xyz + r1.xzw));
	}
	if (p0)
	{
		r0.x = (float)((r1.x * r0.y + -r2.x));
	}
	if (p0)
	{
		r0.yz = (float2)((r1.zw * r0.yy + -r2.yz));
	}
	if (p0)
	{
		r2.xyz = (float3)((r0.www * r0.xyz + r2.xyz));
	}
	r0.x = tfetch2D(
#ifdef __air__
		g_Texture2DDescriptorHeap,
		g_SamplerDescriptorHeap,
#endif
		AdapLumSampler_Texture2DDescriptorIndex, AdapLumSampler_SamplerDescriptorIndex, r1.yy, float2(0, 0), GetTextureLodBias(4)).x;
	ps = clamp(rcp(r0.x), -FLT_MAX, FLT_MAX);
	r0.x = ps;
	...
	r0.xyz = (float3)((r2.xyz * Exposure.xxx + r0.xyz));
