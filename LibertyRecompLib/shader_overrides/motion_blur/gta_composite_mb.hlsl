// Exact XenosRecomp translation of rage_postfx_ps11.bin. The sole behavioral
...
)
{
	...
	r0.w = ps;
	r1.xw = (float2)((r9.yz * (gDirectionalMotionBlurLength.xx * LibertyMotionBlurTimeScale)));
	ps = min(r0.z, r0.w);
	r9.x = ps;
	...
	if (p0)
	{
		r1.y = tfetch2D(
			...
			g_SamplerDescriptorHeap,
#endif
			JitterSampler_Texture2DDescriptorIndex, JitterSampler_SamplerDescriptorIndex, r1.yz, float2(0, 0), GetTextureLodBias(5)).x;
	}
	if (p0)
	{
		ps = -c252.w - -r1.y;
